...
и после послезавтра нет, <br>
не через неделю, <br>
не через дней семь, <br>
и не через две недели <br>
и не через три,<br>
через месяц тоже нет,<br>
через полтора никак, <br>
спустя год я не смогу, <br>
спустя полтора никак, <br>
и не через года два, <br>
и не после лет пяти, <br>
и не после десяти, <br>
не могу я, не могу, <br>
быть свободным вне раю...<br>
</h3></div>`,
